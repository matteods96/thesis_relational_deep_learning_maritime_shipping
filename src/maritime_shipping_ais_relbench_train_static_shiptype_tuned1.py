...
def main():
    ...
    # save results
    output_dir = "ship type prediction/heterogenuos graph_sage_tuned_but_without_ablation_1"
    save_results_to_csv(
    ...
    print('Prediction of the heterogenuos graph sage tuned but without ablation')
