...
TRAINING_CONFIG = {
    ...
    "step_size": int(best_params["step_size"]),
...
def main():
    ...
    # save results
    output_dir = "ship type prediction/heterogenuos graph_sage_tuned_but_without_ablation_db"
    save_results_to_csv(
    ...
    print('Prediction of the heterogenuos graph sage tuned but without ablation on entire db')
