...
def main():
    ...
    # save results
    output_dir = "ship type prediction/heterogenuos graph_sage_configurationF_db"
    save_results_to_csv(
    ...
    print('Prediction of the heterogenuos graph sage  based on entire db under configuration F ')
    # Display parameters
