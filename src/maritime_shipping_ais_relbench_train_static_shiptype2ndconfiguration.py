...
MODEL_CONFIG = {
    ...
    "num_neighbors": [64 for _ in range(2)],
    "num_layers": 4,#it was 2  and 1 before for untuned model
    "channels": 16,
    "aggr": "mean",
...
def main():
    ...
    # save results
    output_dir = "ship type prediction/heterogenuos graph_sage_untuned_db_2ndconfiguration"
    save_results_to_csv(
    ...
    print('Prediction of the heterogenuos graph sage untuned based on entire db with a second configuration ')
