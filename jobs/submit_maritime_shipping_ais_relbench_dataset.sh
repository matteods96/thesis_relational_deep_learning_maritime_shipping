...
### General options 
#BSUB -q hpc
#BSUB -J jobLoadMritimeShippingAISdbRelbenchDataset
#BSUB -n 4
#BSUB -R "span[hosts=1]"
...
#BSUB -B 
#BSUB -N 
#BSUB -o jobMaritimeShippingAISDKRelbenchDataset_%J.out 
#BSUB -e jobMaritimeShippingAISDKRelbenchDataset_%J.err 
...
# Run your script
python maritime_shipping_ais_relbench_dataset.py